...
const ACTION_LABELS: Record<string, string> = {
  ...
  "org.restore": "Organisation Restored",
  "element.create": "Element Created",
  "element.update": "Element Updated",
  "element.reorder": "Elements Reordered",
  "element.delete": "Element Deleted",
  "kpi.create": "KPI Created",
  "kpi.update": "KPI Updated",
  "kpi.delete": "KPI Deleted",
  "kpi.bulkReplace": "KPIs Replaced",
  "matrixCell.create": "Matrix Cell Created",
  "matrixCell.update": "Matrix Cell Updated",
  "matrixCell.delete": "Matrix Cell Deleted",
  "capability.create": "Capability Created",
  "capability.update": "Capability Updated",
  "capability.delete": "Capability Deleted",
  "externalValue.create": "External Value Created",
  "externalValue.update": "External Value Updated",
  "externalValue.delete": "External Value Deleted",
  "factor.create": "Factor Created",
  "factor.update": "Factor Updated",
  "factor.delete": "Factor Deleted",
